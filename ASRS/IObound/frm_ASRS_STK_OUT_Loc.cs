...
namespace ASRS
{
    public partial class frm_ASRS_STK_OUT_Loc : Form
    {
        #region Grid Prarm
        int iCol_Loc = 0;           //儲位
        ...
        public frm_ASRS_STK_OUT_Loc()
        {
            InitializeComponent();
        }

        private void frm_ASRS_STK_OUT_Loc_Load(object sender, EventArgs e)
        {
            GridInit();
            FormInit();
        }
        ...
        private void SubQuery()
        {
            ...
            if (txtItemNo1.Text != "")
            {
                if (txtItemNo2.Text != "")
                {
                    sSql = sSql + "AND D.ITEMNO >= '" + txtItemNo1.Text + "' AND D.ITEMNO <= '" + txtItemNo2.Text + "' ";
                }
                else
                {
            ...
            if (txtLotNo1.Text != "")
            {
                if (txtLotNo2.Text != "")
                {
                    sSql = sSql + "AND D.LOTNO >= '" + txtLotNo1.Text + "' AND D.LOTNO <= '" + txtLotNo2.Text + "' ";
                }
                else
                {
                    sSql = sSql + "AND D.LOTNO = '" + txtLotNo1.Text + "' ";
                }
            }
            if (txtFosbID1.Text != "")
            {
                if (txtFosbID2.Text != "")
                {
                    sSql = sSql + "AND D.FOSBID >= '" + txtFosbID1.Text + "' AND D.FOSBID <= '" + txtFosbID2.Text + "' ";
                }
                else
                {
                    sSql = sSql + "AND D.FOSBID = '" + txtFosbID1.Text + "' ";
                }
            }
            if (txtCust1.Text != "")
            {
                if (txtCust2.Text != "")
                {
                    sSql = sSql + "AND D.CUSTOMER >= '" + txtCust1.Text + "' AND D.CUSTOMER <= '" + txtCust2.Text + "' ";
                }
                else
                {
                    sSql = sSql + "AND D.CUSTOMER = '" + txtCust1.Text + "' ";
                }
            }
            if (chkIndate.Checked == true)
            {
                string sDate1 = date1.Value.ToString("yyyy/MM/dd") + " 00:00:00";
                string sDate2 = date2.Value.ToString("yyyy/MM/dd") + " 99:99:99";

                sSql = sSql + "AND D.TRANSACTION_DATE >= '" + sDate1 + "' AND D.TRANSACTION_DATE <= '" + sDate2 + "' ";
            }            
